...
Partial Class SalesForm
    ...
    Private Sub InitializeComponent()
        ...
        TableLayoutPanelTotal.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 100.0!))
        ...
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Absolute, 50.0!))
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Percent, 100.0!))
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Absolute, 48.0!))
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Absolute, 56.0!))
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Absolute, 65.0!))
        TableLayoutPanelTotal.RowStyles.Add(New RowStyle(SizeType.Absolute, 60.0!))
        ...
        PanelRight.Size = New Size(548, 44)
        ...
        Panel5.Location = New Point(3, 533)
        Panel5.Name = "Panel5"
        ...
        Panel6.Location = New Point(3, 589)
        Panel6.Name = "Panel6"
        ...
        ButtonCheckOut.Location = New Point(3, 654)
        ButtonCheckOut.Name = "ButtonCheckOut"
        ButtonCheckOut.Size = New Size(548, 56)
        ...
        ' === TableLayoutPanel2 (Left Content) ===
        TableLayoutPanel2.ColumnCount = 1
        TableLayoutPanel2.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 100.0!))
        ...
        TableLayoutPanel2.RowStyles.Add(New RowStyle(SizeType.Absolute, 55.0!))
        TableLayoutPanel2.RowStyles.Add(New RowStyle(SizeType.Percent, 100.0!))
        ...
        FlowLayoutPanelSales.Size = New Size(792, 652)
        FlowLayoutPanelSales.TabIndex = 1

        ' === TableLayoutPanel1 (Search Area) ===
        TableLayoutPanel1.ColumnCount = 2
        TableLayoutPanel1.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 70.0!))
        TableLayoutPanel1.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 30.0!))
        TableLayoutPanel1.Controls.Add(ComboBoxCategory, 0, 0)
        TableLayoutPanel1.Controls.Add(ButtonSearch, 1, 0)
        TableLayoutPanel1.Dock = DockStyle.Top
        TableLayoutPanel1.Location = New Point(3, 3)
        TableLayoutPanel1.Size = New Size(792, 49)
        ...
        ComboBoxCategory.Location = New Point(20, 10)

        ButtonSearch.Text = "Search"
        ButtonSearch.Size = New Size(115, 28)
        ButtonSearch.Location = New Point(400, 10)
